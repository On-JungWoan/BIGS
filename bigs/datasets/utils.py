...
from bigs.utils.graphics import fov2focal, get_projection_matrix
from bigs.utils.rotations import batch_look_at_th
...
def get_predefined_pose(pose_type):
    if pose_type == 'da_pose':
        ...
        body_pose = torch.zeros((1, 45), dtype=torch.float32)
        
    return body_pose


def get_smpl_static_params(betas, pose_type='hand', device='cuda'):
