...
sys.path = [".."] + sys.path
import bigs.datasets.arctic.common.thing as thing
from bigs.datasets.arctic.common.rot import axis_angle_to_quaternion, quaternion_apply
from bigs.datasets.arctic.common.torch_utils import pad_tensor_list
from bigs.datasets.arctic.common.xdict import xdict
from bigs.datasets.arctic.environments import DATASET_ROOT
...
def construct_obj(object_model_p):
    ...
    top_sub_p = f"{DATASET_ROOT}/data/arctic_data/data/meta/object_vtemplates/{obj_name}/top_keypoints_300.json"
    ...
    with open(f"{DATASET_ROOT}/data/arctic_data/data/meta/object_meta.json", "r") as f:
...
def construct_obj_tensors(object_names):
    ...
    for k in object_names:
        object_model_p = f"{DATASET_ROOT}/data/arctic_data/data/meta/object_vtemplates/%s" % (k)
